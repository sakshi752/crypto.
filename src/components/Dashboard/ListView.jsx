    ...
    <div className='w-[97%] md:w-[90%] mx-auto flex flex-col gap-5 py-10'>
      {coins.map((coin) => {
        return (
          <div
            key={coin.id}
            className={`flex items-center justify-between cursor-pointer dark:bg-gray-800 bg-gray-300 px-5 py-4 rounded-lg shadow-lg transform transition duration-500 md:hover:scale-105 hover:border-2 ${
